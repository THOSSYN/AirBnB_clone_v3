...
s = '/states/<state_id>/cities'


@app_views.route(s, methods=['GET'], strict_slashes=False)
...
@app_views.route(c, methods=['GET'], strict_slashes=False)
...
@app_views.route(s, methods=['POST'], strict_slashes=False)

...
@app_views.route(r + '/<amenity_id>', methods=['GET'], strict_slashes=False)
...
@app_views.route(r + '/<amenity_id>', methods=['PUT'], strict_slashes=False)
def put_amenity(amenity_id):
    ...
    storage.save()
    return jsonify(per_amenity.to_dict()), 200
